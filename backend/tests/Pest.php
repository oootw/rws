...
function tenantHeaders(User $user): array
{
    return [
        'X-Tenant-Slug' => (string) $user->subdomain_slug,
        'Accept' => 'application/json',
    ];
}

function publicPlaceUrl(Place $place, string $suffix = ''): string
{
    return '/api/public/places/'.$place->id.$suffix;
}
